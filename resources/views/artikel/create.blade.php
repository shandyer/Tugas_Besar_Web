                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                            name="nama_seminar" value="{{ old('nama_seminar') }}" placeholder="nama_seminar">
                                        @error('halaman')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class='form-group'>
                                        ...
                                        @enderror
                                            name="isbn" value="{{ old('isbn') }}" placeholder="ISBN">
                                        @error('isbn')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                </div>
                                <div class="col-12">
                                    <div class='form-group'>
                                        ...
                                        @enderror
                                            name="waktu_pelaksanaan" value="{{ old('waktu_pelaksanaan') }}" placeholder="waktu_pelaksanaan">
